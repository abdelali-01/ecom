...
router.get('/', isAuthenticated, async (req, res) => {
    try {
        ...
        `);
        console.log('Total orders in database:', allOrdersResult[0].total_all_orders);
        ...
        `);
        console.log('Completed orders in database:', completedOrdersResult[0].completed_orders);
        ...
        `, [currentMonth, currentYear]);
        console.log('Current month orders:', currentMonthOrdersResult[0].current_month_orders);
